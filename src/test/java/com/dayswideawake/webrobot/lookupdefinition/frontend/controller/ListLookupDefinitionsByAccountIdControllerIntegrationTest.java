...
public class ListLookupDefinitionsByAccountIdControllerIntegrationTest extends AbstractTestNGSpringContextTests {
	...
	public void listByAccountIdShouldListCorrect1stPageFor1stAccountId() throws Exception{
		...
		mockMvc.perform(requestBuilder)
			...
			.andExpect(content().contentTypeCompatibleWith(jsonContentType))
			.andExpect(jsonPath("$.page.totalElements", is(50)))
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[0].lookupDefinitionId", is(testLookupDefinitions.get(0).getId().intValue())))
			...
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[9].lookupDefinitionId", is(testLookupDefinitions.get(9).getId().intValue())))
	...
	public void listByAccountIdShouldListCorrect2ndPageFor1stAccountId() throws Exception{
		...
		mockMvc.perform(requestBuilder)
			...
			.andExpect(content().contentTypeCompatibleWith(jsonContentType))
			.andExpect(jsonPath("$.page.totalElements", is(50)))
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[0].lookupDefinitionId", is(testLookupDefinitions.get(10).getId().intValue())))
			...
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[9].lookupDefinitionId", is(testLookupDefinitions.get(19).getId().intValue())))
	...
	public void listByAccountIdShouldListCorrect1stPageFor2ndAccountId() throws Exception{
		...
		mockMvc.perform(requestBuilder)
			...
			.andExpect(content().contentTypeCompatibleWith(jsonContentType))
			.andExpect(jsonPath("$.page.totalElements", is(50)))
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[0].lookupDefinitionId", is(testLookupDefinitions.get(50).getId().intValue())))
			...
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[9].lookupDefinitionId", is(testLookupDefinitions.get(59).getId().intValue())))
	...
	public void listByAccountIdShouldListCorrect2ndPageFor2ndAccountId() throws Exception{
		...
		mockMvc.perform(requestBuilder)
			...
			.andExpect(content().contentTypeCompatibleWith(jsonContentType))
			.andExpect(jsonPath("$.page.totalElements", is(50)))
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[0].lookupDefinitionId", is(testLookupDefinitions.get(60).getId().intValue())))
			...
			.andExpect(jsonPath("$._embedded.lookupDefinitionDetailsList[9].lookupDefinitionId", is(testLookupDefinitions.get(69).getId().intValue())))
